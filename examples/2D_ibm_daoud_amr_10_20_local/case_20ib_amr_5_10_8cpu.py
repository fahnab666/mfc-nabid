#!/usr/bin/env python3
"""Short 2D twenty-particle fixed-block AMR test for eight CPU ranks.

Uses the Daoud shock/curtain geometry with 5 cells per particle diameter on
...
dt = ns["CFL"] * min(dx, dy) / (2 * ns["MAX_SIGNAL_SPEED"])
short_steps = 20
