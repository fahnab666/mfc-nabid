...
DESCRIPTIONS = {
    ...
    "particles_lagrange": "Enable Euler-Lagrange particle tracking",
    ...
    "hypo_hll_interface_rhs": "Use an interface-consistent hypoelastic HLL right-hand side",
    "hll_u_interface": "Select the HLL velocity-interface method",
    "reactive_burn": "Enable condensed-phase reactive burn",
    ...
    "T_wrt": "Write each fluid temperature (requires cv > 0)",
    "omega_wrt": "Write vorticity field",
    "cf_wrt": "Write color function field",
    # Immersed boundaries
    "ib": "Enable immersed boundary method",
    "ib_force_wrt": "Write immersed-boundary force history",
    "ib_force_stride": "Write an immersed-boundary force record every N steps",
    "num_ibs": "Number of immersed boundary patches",
    "num_stl_models": "Number of STL/OBJ model entries",
    "num_particle_clouds": "Number of particle-cloud specifications",
    "ib_neighborhood_radius": "Rank-neighborhood radius for immersed-boundary awareness",
    "many_ib_patch_parallelism": "Parallelize immersed-boundary work over patches",
    # Acoustic sources
    ...
    "files_dir": "Directory containing extrusion initial-condition files",
    "file_extension": "Suffix of extrusion initial-condition files",
    ...
    "bf_spatial_support": "Enable spatially supported body force",
    "synthetic_turbulence": "Enable synthetic-turbulence forcing",
    "synth_seed": "Random seed for synthetic turbulence",
    "synth_n_shells": "Number of synthetic-turbulence energy shells",
    "num_turbulent_sources": "Number of synthetic-turbulence source regions",
    "synth_U_inf": "Synthetic-turbulence advection velocity",
    "interface_file": "Path to interface geometry data",
    "normFac": "Interface-data offset",
    "normMag": "Interface-data scale factor",
    "g0_ic": "Gravity for the interfacial initial pressure field",
    "p0_ic": "Reference pressure for the interfacial initial condition",
    ...
    "collision_temporal_resolution": "Minimum adaptive steps used to resolve one collision time",
    "ramp_ratio": "Maximum adaptive-time-step growth factor",
    ...
    "jwl_q_ab": "JWL afterburn energy release per unit mass",
    "jwl_ab_tau": "JWL afterburn time constant",
    "jwl_ab_A": "JWL afterburn Arrhenius prefactor",
    "jwl_ab_theta": "JWL afterburn activation temperature",
    "jwl_ab_n": "JWL afterburn pressure exponent",
    "jwl_reactive": "Enable pressure-driven JWL reactive burn",
    "jwl_G": "JWL reactive-burn rate constant",
    "jwl_b_exp": "JWL reactive-burn pressure exponent",
    "prog_burn": "Enable kinematic JWL programmed burn",
    "pb_D_cj": "Programmed-burn Chapman-Jouguet detonation velocity",
    "pb_width": "Programmed-burn reaction-zone width",
    "pb_x_det": "Programmed-burn detonation x-coordinate",
    "pb_y_det": "Programmed-burn detonation y-coordinate",
    "pb_z_det": "Programmed-burn detonation z-coordinate",
    "pb_t_det": "Programmed-burn initiation time",
...
def get_description(param_name: str) -> str:
    """Get description for a parameter from hand-curated or inferred sources.

    Priority: hand-curated DESCRIPTIONS > PATTERNS > naming-convention
    inference. This function is called during parameter registration, so it
    must not query the registry.
    """
    ...
    # 3. Last resort: naming convention inference
