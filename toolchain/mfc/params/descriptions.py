...
DESCRIPTIONS = {
    ...
    "jwl_afterburn": "Enable JWL afterburn energy release (adds a progress variable equation)",
    "jwl_ab_model": "Afterburn rate model: 1 = mixing-rate, 2 = Arrhenius (default)",
    "jwl_q_ab": "Afterburn specific energy release (J/kg products)",
    "jwl_ab_tau": "Afterburn mixing time scale (model 1)",
    "jwl_ab_A": "Afterburn Arrhenius prefactor (model 2)",
    "jwl_ab_theta": "Afterburn activation temperature (model 2)",
    "jwl_ab_n": "Afterburn pressure exponent (model 2)",
    "prog_burn": "Enable kinematic program burn (lighting-time energy release)",
    "pb_D_cj": "Program burn detonation front speed",
    "pb_width": "Program burn reaction zone width",
    "pb_x_det": "Detonation point x-coordinate",
    "pb_y_det": "Detonation point y-coordinate",
    "pb_z_det": "Detonation point z-coordinate",
    "pb_t_det": "Detonation initiation time",
    "jwl_reactive": "Enable JWL++ pressure-driven reactive burn (adds a reaction progress equation)",
    "jwl_G": "JWL++ reaction rate coefficient",
    "jwl_b_exp": "JWL++ reaction pressure exponent",
    ...
    "collision_steps_per_contact": "Minimum adaptive timesteps per soft-sphere contact (default 20; fixed timesteps are user-controlled)",
...
PATTERNS = [
    ...
    (
        r"fluid_pp\((\d+)\)%jwl_delta_e",
        "JWL reactant/product energy offset (<= 0, J/kg) for fluid {0}; with jwl_reactive gives unreacted material a stiffer Hugoniot (ZND/von Neumann spike), 0 disables",
    ),
    # patch_ib patterns
