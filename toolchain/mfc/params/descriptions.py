...
PATTERNS = [
    ...
    (r"fluid_pp\((\d+)\)%eos", "EOS selector for fluid {0} (1 = stiffened gas, 2 = JWL)"),
    ...
    (r"fluid_pp\((\d+)\)%jwl_ej_rho_ref", "JWL closure products-energy reference density for fluid {0}; default jwl_rho0"),
    (r"fluid_pp\((\d+)\)%jwl_delta_e", "JWL reactant/product energy offset (<= 0, J/kg) for fluid {0}; 0 disables"),
