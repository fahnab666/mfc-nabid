...
def __filter(cases_) -> typing.Tuple[typing.List[TestCase], typing.List[TestCase]]:
    ...
    #  - the four UUIDs: intermittent post-detected NaN on Lagrangian-bubble goldens with the
    #    NVHPC 24.1/24.3 compat images (-tp=px -Kieee + HPC-X under the CI docker image);
    #    unreproducible natively/Apptainer and green on 24.5+ (B9553426 One-way, 4A1BD9B8 Two-way,
    #    0D1FA5C5 One-way adap_dt, 2122A4F6 Two-way adap_dt). Native nvfortran runs still cover all four.
