...
module m_derived_types
    ...
    type ib_patch_parameters
        ...
        integer :: geometry      !< Type of geometry for the patch
        integer :: gbl_patch_id  !< Global patch index used for IB patch periodicity encoding
    ...
    type physical_parameters
        ...
        real(wp)               :: jwl_delta_e     !< Reactant/product energy offset for jwl_reactive (0 = feature off; must be <= 0)
