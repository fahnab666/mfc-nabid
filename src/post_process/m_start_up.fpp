...
contains
    ...
    impure subroutine s_read_input_file
        ...
        namelist /user_inputs/ case_dir, m, n, p, t_step_start, t_step_stop, t_step_save, model_eqns, num_fluids, mpp_lim, &
            ...
            & bubbles_lagrange, sim_data, hyperelasticity, Bx0, relativity, cont_damage, hyper_cleaning, jwl_afterburn, &
            & jwl_reactive, num_bc_patches, igr, igr_order, down_sample, recon_type, muscl_order, lag_header, lag_txt_wrt, &
            ...
            & alpha_rho_e_wrt, ib_state_wrt, particles_lagrange, particle_pp
