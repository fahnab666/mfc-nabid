...
contains
    ...
    impure subroutine s_compute_dt()
        ...
        $:GPU_PARALLEL_LOOP(collapse=3, private='[Y_jwl, lambda_jwl, vel, alpha, alpha_rho, Re, rho, vel_sum, pres, gamma, &
                            & pi_inf, c, qv, fl, max_dt]', reduction='[[dt_local]]', reductionOp='[min]')
        do l = 0, p
            do k = 0, n
                do j = 0, m
