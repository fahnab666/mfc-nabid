...
module m_global_parameters
    ...
    !> ALLOCATION bounds for the solver working set, as distinct from the RUNTIME bounds in idwbuff. Currently always equal to
    !! idwbuff.
    ...
    !! of idwbuff: m_riemann_solvers, m_weno, and the x/y/z_cb grid-coordinate family. Currently always equal to m/n/p.
