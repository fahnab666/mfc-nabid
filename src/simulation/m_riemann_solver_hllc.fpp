...
contains
    ...
    subroutine s_hllc_riemann_solver(qL_prim_rsx_vf, dqL_prim_dx_vf, dqL_prim_dy_vf, dqL_prim_dz_vf, qL_prim_vf, qR_prim_rsx_vf, &
        ...
        mg_mixture_loc = mg_mixture  !< host copy; amdflang reads the declare-target original stale cross-TU
            ...
            if (norm_dir == ${NORM_DIR}$) then
                ...
                if (model_eqns == model_eqns_6eq) then
                    ...
                    $:GPU_PARALLEL_LOOP(collapse=3, private='[i, j, k, l, vel_L, vel_R, Re_L, Re_R, alpha_L, alpha_R, &
                                        ...
                                        & firstprivate='[Re_size_loc1, Re_size_loc2, mg_mixture_loc]')
                    ...
                    $:GPU_PARALLEL_LOOP(collapse=3, private='[i, q, R0_L, R0_R, V0_L, V0_R, P0_L, P0_R, pbw_L, pbw_R, vel_L, &
                                        ...
                                        & h_avg_2]', firstprivate='[Re_size_loc1, Re_size_loc2, mg_mixture_loc]')
                    do l = ${Z_BND}$%beg, ${Z_BND}$%end
                        do k = ${Y_BND}$%beg, ${Y_BND}$%end
                            do j = ${X_BND}$%beg, ${X_BND}$%end
                                vel_L_rms = 0._wp; vel_R_rms = 0._wp
                    ...
                    $:GPU_PARALLEL_LOOP(collapse=3, private='[i, T_L, T_R, vel_L_rms, vel_R_rms, pres_L, pres_R, rho_L, gamma_L, &
                                        ...
                                        & h_iL, h_iR, h_avg_2, G_L, G_R]', copyin='[is1, is2, is3]', firstprivate='[Re_size_loc1, &
                                        & Re_size_loc2, mg_mixture_loc]')
                    do l = ${Z_BND}$%beg, ${Z_BND}$%end
                        do k = ${Y_BND}$%beg, ${Y_BND}$%end
                            do j = ${X_BND}$%beg, ${X_BND}$%end
                                vel_L_rms = 0._wp; vel_R_rms = 0._wp
