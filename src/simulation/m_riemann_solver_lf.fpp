        ...
        #:for NORM_DIR, XYZ, STENCIL_VAR, COORDS, X_BND, Y_BND, Z_BND in &
            ...
            if (norm_dir == ${NORM_DIR}$) then
                $:GPU_PARALLEL_LOOP(collapse=3, private='[i, j, k, l, alpha_rho_L, alpha_rho_R, vel_L, vel_R, alpha_L, alpha_R, &
                                    ...
                                    & Cv_R, R_gas_L, R_gas_R, MW_L, MW_R, T_L, T_R, Y_L, Y_R, Gamm_L, Gamm_R, e_jwl_L, e_jwl_R, &
                                    & Y_jwl_L, Y_jwl_R, lambda_jwl_L, lambda_jwl_R]', firstprivate='[Re_size_loc1, Re_size_loc2]')
