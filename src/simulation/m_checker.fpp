...
contains
    ...
    impure subroutine s_check_inputs
        ...
        ! All JWL input constraints (eos_jwl incompatibilities, jwl_reactive,
        ! jwl_afterburn, prog_burn) live in toolchain/mfc/case_validator.py
        ! (check_stiffened_eos) since they are pure case-file checks.
